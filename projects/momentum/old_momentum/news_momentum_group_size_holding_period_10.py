'''
Viable_news:
days when a group of news appears of the size greater than average size of 
biggest groups within a days
Returns:
days with returns adjusted by std. deviation greater/smaller than a certain threshold
'''
