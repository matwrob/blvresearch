...
DESCRIPTION_BUY = """
This is a BUY signal generated by %s-day Moving Average strategy.\n
%s days ago the price of this stock exceeded the average of the previous
%s days.\n
The signal was generated after the price stayed above the average for the
next %s days, which was to confirm correctness of the signal.
"""

DESCRIPTION_SELL = """
This is a SELL signal generated by %s-day Moving Average strategy.\n
%s days ago the price of this stock went below the average of the previous
%s days.\n
The signal was generated after the price stayed below the average for the
next %s days, which was to confirm correctness of the signal.
"""

DESCRIPTION_COMMON = """
This Moving Average strategy uses exponential weighting and not equal
weighting which is used in simple moving averages. Exponential moving averages
give more weight to more recent days and therefore better adapts to changes
of the price.
...
def get_movavg_descr(signal, window, confirmation_window):
    if signal == True:
        result = DESCRIPTION_BUY % (window, confirmation_window, window,
                                    confirmation_window)
    elif signal == False:
        result = DESCRIPTION_SELL % (window, confirmation_window, window,
                                     confirmation_window)
...
#     """this strategy where ma of returns is compared to returns works
#     better but makes no sense
#
#     """
#     returns = data['alpha']
#     # prices = to_prices(returns, set_first_to_na=True)
