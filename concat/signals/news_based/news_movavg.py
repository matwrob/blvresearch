...
(2) what was the return over 3 days (including signal day)
(3) if over the previous 5 or the next 2 days (including that day) a buy/sell
    signal - generated by MA strategy - occurred and if this signal
    is in line with news based signal
...
* in the previous 8 days a buy signal generated by Moving Average also occurred
"""
...
* in the previous 8 days a sell signal generated by Moving Average also
occurred
"""
